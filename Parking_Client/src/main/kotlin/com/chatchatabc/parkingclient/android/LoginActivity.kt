...
class LoginActivity: ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.requiresUsername.value = true
                                ...
                                when (loginState) {
                                    LoginState.PHONE -> LoginView(
                                        ...
                                        onPhoneChanged = {
                                            ...
                                            viewModel.appErrors.value = viewModel.appErrors.value.filter { it.key != "phone" }
                                        },
                                        onUsernameChanged = {
                                        ...
                                        onTosChanged = {
                                            ...
                                            viewModel.appErrors.value = viewModel.appErrors.value.filter { it.key != "tos" }
                                        },
                                        onLogin = {
                                            viewModel.validateAndSubmitPhone(LoginType.MEMBER)
                                        }
                                    )
                                    ...
                                    LoginState.OTP -> OTPView(
                                        ...
                                        onOTPChanged = { otp ->
                                            ...
                                            viewModel.appErrors.value = viewModel.appErrors.value.filter { it.key != "otp" }
                                        }
                                    ) {
