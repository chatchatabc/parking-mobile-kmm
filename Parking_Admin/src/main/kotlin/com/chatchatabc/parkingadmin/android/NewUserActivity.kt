...
@Composable
fun NewUserView(viewModel: NewUserViewModel, onContinue: () -> Unit = {}) {
                ...
                Card(
                    ...
                    Box(
                        ...
                        Column {
                            ...
                            Text(text = "Email", style = MaterialTheme.typography.labelLarge, modifier = Modifier.padding(top = 16.dp))
                            OutlinedTextField(
                                modifier = Modifier.fillMaxWidth(),
                                value = email,
...
//                            label = { Text("Email") },
                ...
                }, modifier = Modifier.fillMaxWidth().heightIn(ButtonDefaults.MinHeight), colors = ButtonDefaults.elevatedButtonColors()) {
                    Text("Save")
                }
            }
                    ...
                    Card(
                        ...
                        Box(
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                Icon(Icons.Filled.Check, contentDescription = "Check", modifier = Modifier.size(64.dp))
                                Text(text = "Your details have been saved.", style = MaterialTheme.typography.bodyLarge)
                            }
                        }
                    }
                    Button(onClick = {
                                     onContinue()
                    }, modifier = Modifier.fillMaxWidth().height(40.dp), colors = ButtonDefaults.elevatedButtonColors()) {
                        Text("Continue")
                    }
                }
            }
